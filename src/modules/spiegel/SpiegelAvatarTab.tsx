...
export function SpiegelAvatarTab({ spaceId }: SpiegelAvatarTabProps) {
  ...
  return (
    <div className="h-full grid grid-cols-1 md:grid-cols-2 gap-2 min-h-0">
      {/* Links: Avatar */}
      <div className="rounded-xl bg-amber-50/60 flex flex-col h-full min-h-0 overflow-hidden">
        <div className="flex-1 p-3 flex flex-col items-center gap-2 overflow-y-auto">
        <Avatar
          name={userName}
      ...
      {/* Rechts: Items */}
      <div className="rounded-xl bg-amber-50/60 overflow-hidden flex flex-col h-full min-h-0">
        <div className="px-3 py-2 bg-amber-100/40 flex items-center gap-2 flex-wrap">
